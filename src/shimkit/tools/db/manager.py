...
class DbManager:
    ...
    def boot(self, *, force: bool = False) -> DbManager:
        # Preflight the docker binary version constraint, then verify
        # the SDK + daemon. preflight() raises VersionViolationError;
        # we map to exit 69 with the structured remediation message
